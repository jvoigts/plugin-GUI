...
private:
    ...
    ScopedPointer<Label> outputImageSizeSelectionW;
    ScopedPointer<Label> outputImageSizeSelectionWLabel;
    ScopedPointer<Label> outputImageSizeSelectionH;
    ScopedPointer<Label> outputImageSizeSelectionHLabel;
